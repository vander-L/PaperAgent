...
// Create 创建SSE连接
func (s *SSEService) Create(ctx context.Context, r *ghttp.Request) (*SSEClient, error) {
	// 设置SSE必要的HTTP头
...
func (c *SSEClient) SendToClient(eventType, data string) bool {
	msg := fmt.Sprintf(
		"id: %d\nevent: %s\ndata: %s\n\n",
